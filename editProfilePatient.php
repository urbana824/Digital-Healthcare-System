...
<head>
  ...
  <link rel="stylesheet" href="editProfilePatient.css">
</head>
<body>
  ...
  session_start();
    ...
    if(isset($_POST['update'])){
      ...
      $email =  $_POST['email'];
      $pass =  $_POST['pwd'];
      $sql= "UPDATE register SET Name='$name',Age='$age',Phone_number='$phn',Email='$email',Password='$pass' WHERE Email='$session_user'";
  ...
  if(isset($_POST['cancel'])){
    header("Location:myAccountPatient.php");
  }
   ?>
        ...
        <div class="sign">
          <form action="" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="age" placeholder="Enter age"   name="userage">
            </div>
            <div class="form-group">
