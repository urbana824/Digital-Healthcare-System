...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="signupAsPatient.css">
  </head>
  <body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
           <li> <a href="loginAsPatient.php"> <span class="glyphicon glyphicon-log-in"></span> Login </a>  </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="sign">
      <form action="insertPatientInfo.php" method="POST">
        ...
        <div class="form-group">
          ...
          <input required type="number" class="form-control" name="age" placeholder="Enter age"   name="userage">
        </div>
        <div class="form-group">
    ...
    <div class="text1">
       <p id="p1"> already have an account?  <a id="a1" href="loginAsPatient.php">login</a> </p>
    </div>
