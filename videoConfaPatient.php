...
session_start();
     ...
     $sql= "SELECT * FROM videoconference";
...
<html lang="en">
<head>
  <title>Video Confarence schedules</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="videoConfaPatient.css">
</head>
<body>
        ...
        <table class="table table-bordered table-hover table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <?php echo '<a href='.$links.' target="_blank">'.$links.'</a>'; ?> </td>
