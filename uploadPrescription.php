...
<head>
  ...
  <link rel="stylesheet" href="uploadPrescription1.css">
</head>
<body>
...
if(isset($_POST['submit'])){
    ...
    $sqlquery = "INSERT INTO prescription VALUES('NULL','$doctor_id','$doctor_name','$doctor_email','$patient_id', '$patient_email', '$prescription')";
    if(mysqli_query($conn, $sqlquery)){
      $_SESSION['succes']=true;
      header("Location:uploadPrescription.php?success=1");
    }
    else{
      ...
      <div class="col-md-8 bg-info">
        ...
        <div class="sign">
          <form action="" method="POST">
            ...
            <h3 class="text-info">Write down the prescription</h3>
            <textarea name="prescription" class="form-control" rows="11"></textarea>
